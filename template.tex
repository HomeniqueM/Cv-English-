...
\begin{document}
\header{Homenique Vieira Martins}{Cientista da computação} 
...
\address{ Belo Horizonte -  Minas Gerais} % Endereço
\phonenumber{(31) 9 9275-3490} % Phone number
...
\profile{Sou um estudante de ciência da computação apaixonado por leitura, código limpo e criação de interfaces. }
...
\knowledge{%
  {Básico: MySQL,Firebase,Google cloud},\newline\newline
  {Intermediário: C/C++,Flutter, Java,Git e Github.},\newline\newline%
  {Avançado: Linux, Windows e Pacote Office. }%
}
%----------------------------------------------------------------------------------------
